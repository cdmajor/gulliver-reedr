...
export default function Support() {
  const faqs = [
    ...
    { q: "How do developers test locally?", a: "From the repo: npm install, then npm run verify (structure checks), npm run dev (website at http://localhost:5173), and open /reedr-demo.html for the fake chat UI. For the real extension, run npm run pack:extension, load public/reedr-extension as an unpacked extension, set the API URL in Settings if needed, then chat on a real page. npm test runs verify + typecheck + website build." },
