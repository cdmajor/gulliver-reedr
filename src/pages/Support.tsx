...
export default function Support() {
  const faqs = [
    ...
    { q: "Does Reedr work on PDFs?", a: "Reedr can discuss PDF text when the page exposes it. Chrome’s built-in PDF viewer often blocks extensions, so open the PDF in a normal webpage viewer or use another browser if the purple R doesn’t appear." },
    { q: "I installed Reedr but don’t see the purple R", a: "Refresh the page or open a new http(s) article (news, docs, blog). Reedr does not appear on chrome:// pages, the new-tab page, or the Chrome Web Store. You can also click the Reedr toolbar icon for a quick tip." },
