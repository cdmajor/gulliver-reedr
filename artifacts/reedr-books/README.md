...
- **Research aid** — text-grounded lenses: claims & evidence, key concepts, research questions, source map, reading notes (not a paper writer)
- **Mobile calculator keypad** — docked chassis with LCD + symbol+word keys (Σ Summarize …) and `=` Compute
- **Verse links** — sentences numbered like Bible verses; tap a number in chapter text or summaries to select for Compute
